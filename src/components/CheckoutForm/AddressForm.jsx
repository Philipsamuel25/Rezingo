...
console.log(fetchShippingOptions,"fetchShippingOptions");
    useEffect(()=>{
        ...
        <>
           ...
           <Typography variant={"h6"} gutterBottom> Shipping Address</Typography>
            ...
            <FormProvider {... methods}>
                <form onSubmit={methods.handleSubmit((data) => next({...data,shippingCountry,shippingSubdivision,shippingOption})(onSubmit))}>
