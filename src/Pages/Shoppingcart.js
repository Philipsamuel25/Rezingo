...
import Removingcart from './Removingcart';
...
// let headers = {
// 	"X-Authorization": "pk_25095f6ed4dac89f69f1e4337484555ec6c07ef2fc5d8",
					...
					<div className="row col-mb-30">
						<div className="col-lg-6">
							...
							<form className="row">
								...
								<div className="col-12 form-group">
									<button className="button button-3d m-0 button-black">Update Totals</button>
								</div>
							</form>
						</div>
								...
								<table className="table cart cart-totals">
									<tbody>
										<tr className="cart_item">
											...
											<td className="cart-product-name">
												<span className="amount">$106.94</span>
											</td>
										</tr>
										<tr className="cart_item">
											<td className="cart-product-name">
										...
										<tr className="cart_item">
											...
											<td className="cart-product-name">
												<span className="amount color lead"><strong>$106.94</strong></span>
											</td>
										</tr>
									</tbody>
